<x-app-layout>
    ...
    <div class="max-w-7xl m-4 mx-auto ">
        <div class="overflow-hidden sm:rounded-lg">
            <div class="mx-auto">
                <div class="flex justify-between items-center py-4">
                    ...
                    <p class="tracking-wide font-bold rounded @if(round($quizAverage,2)<70) @endif  @if(round($quizAverage,2)>=70) bg-green-600 @endif text-white shadow-md py-2 px-6 items-center">Average Score: <span class="mx-2"> {{round($quizAverage,2) .'%'}}</span></p>
                </div>
