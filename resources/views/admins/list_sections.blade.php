<x-app-layout>
    ...
    <div class="max-w-7xl m-4 mx-auto sm:px-6 lg:px-8">
        <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg">
            <div class="mx-auto">
                <div class="hidden flex justify-between items-center py-4">
                        ...
                        <div class="py-2 align-middle inline-block min-w-full sm:px-6 lg:px-8">
                            <div class="shadow overflow-hidden border-b border-gray-200 sm:rounded-lg">
                                <table class="min-w-full divide-y divide-gray-200">
                                    <thead class="tracking-wide font-bold rounded border-2 bg-[#DB6060] text-white  transition shadow-md py-2 px-6 items-center">
                                        <tr>
                                        ...
                                        <tr class="hover:bg-green-100">
                                            ...
                                            <td class="px-6 py-1 text-center">
                                                <div class="text-sm text-gray-900">
                                                    ...
                                                    <span class="bg-[#78DB60] px-5 py-1 rounded-md uppercase">Ya</span>
                                                    @else
                                                    <span class="bg-[#DB6060] px-5 py-1 rounded-md uppercase">Tidak</span>
                                                    @endif
                                                </div>
                                            </td>
                                            <td class="px-6 py-1 text-center">
