<x-app-layout>
  <div class="w-screen h-screen bg-black opacity-[59%] absolute">
  </div>
  <div class="flex flex-col justify-center relative">
    <div class="ml-12 mt-10 w-full h-full">
    ...
    <div class="mt-16">
      ...
      <div class="mt-10">
        ...
        $time_taken = $datum['total_time']->days*86400 + $datum['total_time']->h*3600
        ...
        <div class="grid grid-cols-4 mx-2 rounded-2xl bg-gray-300 my-5 py-5">
          ...
          <div class="text-center uppercase text-lg font-bold">
            <progress class="text-base leading-relaxed xl:w-2/4 lg:w-3/4 mx-auto mr-3" id="quiz-{{$i}}" value="{{ $datum['score'] }}" max="100"> {{ $datum['score'] }} </progress>{{ $datum['score'] }}%</div>
        </div>
        @endforeach
      </div>
    </div>
